...
INSERT INTO `users` (`user_id`, `user_fname`, `user_lname`, `role`, `username`, `password`, `user_created`) VALUES
(1, 'Dharyll', 'Cocos', 'admin', 'admin', 'admin', '2023-04-16'),
(2, 'Jay', 'Jo', 'nurse', 'nurse', 'nurse', '2023-04-16');
